...
<div class="row test-desc mar-t-0-m" id='intro-test'>
    <div class="col-sm-8 col-sm-offset-2">
        ...
        <div class="col-sm-9">
            <h3 class="ta-center-m mar-t-0-m">Subtes 1: Pengetahuan Umum</h3>
            <div class="ta-center-m">
                <h4><strong>Petunjuk Pengerjaan</strong></h4>
                <p class="mar-b-0 text-justify">Buku ini berisi kumpulan soal berupa pertanyaan seputar pengetahuan umum
                    yang disertai dengan empat pilihan jawaban. Tugas Anda adalah untuk memilih satu jawaban yang
                    dianggap paling benar dari keempat pilihan tersebut dengan menuliskan huruf jawaban di dalam kotak
                    sesuai nomor pada lembar jawaban Anda.</p>
        ...
        <div class="tool" id='tool-1'>
            ...
            <div class="va-table mar-0-auto">
                <div class="va-middle ta-center">
                    ...
                    <div class="ta-center" id="petunjuk-pengerjaan"
                        ...
                        <p class="mar-b-0 text-justify">Buku ini berisi kumpulan soal berupa pertanyaan seputar
                            pengetahuan umum yang disertai dengan empat pilihan jawaban. Tugas Anda adalah untuk memilih
                            satu jawaban yang dianggap paling benar dari keempat pilihan tersebut dengan menuliskan
                            huruf jawaban di dalam kotak sesuai nomor pada lembar jawaban Anda.</p>
                    </div>
                </div>
            </div>
            <div class="step question pad-0-m mar-t-3em-m" id='qt-1' style='display: block; width:100%;'>
                ...
                <div class="navigation">
                    ...
                    <div class="va-table mar-0-auto">
                        <div><button class='btn btn-success' onclick="start(2, {{ $job_id }}, 1)"><span

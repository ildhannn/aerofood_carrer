...
<div class="profile-section pad-0 minHeight">
    <div class="va-table width-100" style="padding:20px 20px 20px 20px;background:#dcdcdc;">
        ...
        <div class="va-middle dis-tab-row-m ta-right ta-center-m"><a href="{{route('create-candidate-experience')}}" class='btn btn-success'><i class="fa fa-plus" style="width:auto !important;"></i>&nbsp;&nbsp;TAMBAH PENGALAMAN</a></div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class='btn btn-danger cancel-delete' href='#'><i class="fa fa-close" style="width:auto;"></i>&nbsp;&nbsp;Batal</a>
                <a class='btn btn-success delete-trash delete-experience'><i class="fa fa-envelope" style="width:auto;"></i>&nbsp;&nbsp;Hapus Pengalaman</a>
            </div>
        </div>
    </div>
</div>

                ...
                <div class="row mar-b-0">
                    <div class="col-md-6">
                        ...
                        <div class="form-group" id="start_date">
                            ...
                            <div class="col-md-12">
                                <input id="start_date" type="date" class="form-control" name="start_date"
                                    value="{{ $experience->start_date }}" placeholder="Waktu mulai" {{$experience->still_work == 'on' ? '' : 'required'}}>
                        ...
                        <div class="form-group" id="end_date">
                            ...
                            <div class="col-md-12">
                                <input id="end_date" type="date" class="form-control" name="end_date"
                                    value="{{ $experience->end_date }}" placeholder="Waktu berakhir" {{$experience->still_work == 'on' ? '' : 'required'}}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class='form-control' id='nationality' name='nationality' required>
                                    ...
                                    <option value='1' {{ $experience->nationality == 1 ? 'selected' : '' }}>Indonesia
                                    </option>
                                    <option value='0' {{ $experience->nationality == 0 ? 'selected' : '' }}>Asing
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="form-group nationality"
                            style="display: {{ $experience->nationality == 1 ? 'none' : 'block' }}">
                            <div class="col-md-12">
                                <input id="aboard_location" type="text" class="form-control" name="aboard_location"
                                    value="{{ $experience->aboard_location }}" placeholder="Negara">
                                ...
                                <select class='form-control' id='province' name='province_id'>
                                    ...
                                    @foreach ($provinces as $province)
                                        <option value='{{ $province->id }}'
                                            {{ $experience->province_id == $province->id ? 'selected' : '' }}>
                                ...
                                <select class='form-control' id='city' name='city_id'>
                                    ...
                                    @foreach ($cities as $city)
                                        <option value='{{ $city->id }}' data-province='{{ $city->province_id }}'
                                            {{ $experience->city_id == $city->id ? 'selected' : '' }}>{{ $city->city }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class='form-control' id='field_id' name='field_id' required>
                                    ...
                                    @foreach ($fields as $field)
                                        <option value='{{ $field->id }}'
                                            {{ $experience->field_id == $field->id ? 'selected' : '' }}>
                                            {{ $field->field }}</option>
                                    @endforeach
                                </select>
                            </div>

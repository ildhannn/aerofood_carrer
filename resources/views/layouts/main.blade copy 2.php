...
<body class="erec">
	...
	<script type="text/javascript" src="{{asset('js/js_bs_new/bootstrap.min.js')}}"></script>
			...
			<div class="container pad-l-0-m pad-r-0-m">
				...
				<div class="col-md-5 menu-footer">
	                <div class="va-table fs-13 height-130 height-auto-m mar-b-2em-m" style="width:100%; text-align: center; margin:0 auto;">
						...
						@else
						<div class="va-middle">                        
				            <div class="pad-r-1em"><a href="{{route('candidate-job')}}">Beranda</a></div>
	                    </div>
	                    <div class="va-middle">                        
				            <div class="pad-r-1em"><a href="{{route('candidate-profile')}}">Profile</a></div>
	                    </div>
						@endif
	                    <div class="va-middle">                        

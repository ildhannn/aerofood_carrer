		...
		<nav class="sidebar hidden-xs">
		    <div style="position:relative;height:100vh;">
                ...
                <ul>
                    ...
                    <li class="{{ $route == 'dashboard-candidate' || $route == 'detail-candidate' ? 'active' : ''}}"><a href="{{route('dashboard-candidate')}}"><i class="fa fa-users"></i>Kandidat</a></li>
                    <li class="{{ $route == 'dashboard-keahlian' || $route == 'detail-keahlian' ? 'active' : ''}}"><a href="{{route('dashboard-keahlian')}}"><i class="fa fa-gavel"></i>Keahlian</a></li>
					<li class="{{ $route == 'dashboard-pvi' || $route == 'dashboard-create-pvi' ? 'active' : ''}}"><a href="{{route('dashboard-pvi')}}"><i class="fa fa-video-camera"></i>Master PVI</a></li>
                    <li class="{{ $route == 'dashboard-soal' || $route == 'dashboard-create-soal' ? 'active' : ''}}"><a href="{{route('dashboard-soal')}}"><i class="fa fa-list-ol"></i>Master Soal</a></li>
					<li
                    ...
                    <li class="{{ $route == 'dashboard-faq' || $route == 'dashboard-create-faq' ? 'active' : ''}}"><a href="{{route('dashboard-faq')}}"><i class="fa fa-question"></i>Master FAQ</a></li>

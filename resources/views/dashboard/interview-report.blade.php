                                ...
                                <thead style="background: #f2f2f2;">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">User 2 <a href="#interview-6"
                                                class='btn btn-primary'>Evaluasi</a></td>
                                        <td align="center">User 3<a href="#interview-7" class='btn btn-primary'>Evaluasi</a>
                                        </td>
                                    </tr>
                                </thead>
                                <tbody>
                                                ...
                                                <div class="va-table width-100">
                                                    <div class="va-middle">
                                                        @if ($resultDetails[4] != null)
                                                            <div>
                                                                <span><i class="fa fa-star"
                                                                        style="color: {{ $resultDetails[4]['rating'] >= 1 ? '#FF912C' : '#666666' }};"></i></span>
                                                                <span><i class="fa fa-star"
                                                                        style="color: {{ $resultDetails[4]['rating'] >= 2 ? '#FF912C' : '#666666' }};"></i></span>
                                                                <span><i class="fa fa-star"
                                                                        style="color: {{ $resultDetails[4]['rating'] >= 3 ? '#FF912C' : '#666666' }};"></i></span>
                                                                <span><i class="fa fa-star"
                                                                        style="color: {{ $resultDetails[4]['rating'] >= 4 ? '#FF912C' : '#666666' }};"></i></span>
                                                                <span><i class="fa fa-star"
                                                                        style="color: {{ $resultDetails[4]['rating'] >= 5 ? '#FF912C' : '#666666' }};"></i></span>
                                                            </div>
                                                        @else
                                                            <div>
                                                                <span><i class="fa fa-star"
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;"
                                            class="text-center {{ $class[$interviewResults[4]] }}">
                                            {{ $result[$interviewResults[4]] }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>

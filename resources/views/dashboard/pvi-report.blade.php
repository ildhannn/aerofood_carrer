			...
			<div class="va-middle" style="width:95%; background: #f2f2f2;">
				...
				<div class="va-table width-100" style="font-size: 13px;">
					...
					<div class="va-middle" style="width:94%; background: #f2f2f2; padding: 1em;">
						...
						@if($pvi->answer)
							<a href="#" type="button" class='view btn btn-primary' data-toggle="modal" data-target="#myModal" data-question='{{$pvi->question}}' data-video='{{asset("upload/candidates/".md5($candidate->candidate_id."folder")."/".$pvi->answer)}}'><i class="fa fa-eye"></i>&nbsp;Lihat Hasil</a>
						@else

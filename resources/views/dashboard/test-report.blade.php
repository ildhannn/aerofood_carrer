...
@section('content')
    ...
    <div class="panel" style="border-top: none;">
        ...
        <div class="tab-content">
            <div class="list-item tab-pane active" role='tab-panel' id='mbti'>
                <button class='btn btn-success' id='btn' onclick='printmbti();'>print</button>
                <div id='mbtiprint'>
            ...
            <div class="list-item tab-pane" role='tab-panel' id='disc'>
                <button class='btn btn-success' id='btn' onclick='printdisc();'>print</button>
                <div id='discprint'>
                                    ...
                                    <thead>
                                        <tr>
                                            <th colspan="5" align="center"
                                                style="text-align: center;padding: 1em; width:50%; background: #F00;">MOST
                                            </th>
                                            <th colspan="5" align="center"
                                                style="text-align: center;padding: 1em; width:50%; background: #0F0;">LEAST
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center" data-dm="{{ $disc['dm'] }}"
                                                style="background: #f2f2f2;">
                                                <b>{{ $disc['dm'] }}</b>
                                            </td>
                                            <td align="center" data-im="{{ $disc['im'] }}"
                                                style="background: #f2f2f2;">
                                                <b>{{ $disc['im'] }}</b>
                                            </td>
                                            <td align="center" data-sm="{{ $disc['sm'] }}"
                                                style="background: #f2f2f2;">
                                                <b>{{ $disc['sm'] }}</b>
                                            </td>
                                            <td align="center" data-cm="{{ $disc['cm'] }}"
                                                style="background: #f2f2f2;">
                                                <b>{{ $disc['cm'] }}</b>
                                            </td>
                                            <td align="center" data-bm="{{ $disc['bm'] }}"
                                                style="background: #f2f2f2;">
                                                <b>{{ $disc['bm'] }}</b>
                                            </td>
                                            <td align="center" data-dl="{{ $disc['dl'] }}"
                                                style="background: #f2f2f2;">
                                                <b>{{ $disc['dl'] }}</b>
                                            </td>
                                            <td align="center" data-il="{{ $disc['il'] }}"
                                                style="background: #f2f2f2;">
                                                <b>{{ $disc['il'] }}</b>
                                            </td>
                                            <td align="center" data-sl="{{ $disc['sl'] }}"
                                                style="background: #f2f2f2;">
                                                <b>{{ $disc['sl'] }}</b>
                                            </td>
                                            <td align="center" data-cl="{{ $disc['cl'] }}"
                                                style="background: #f2f2f2;">
                                                <b>{{ $disc['cl'] }}</b>
                                            </td>
                                            <td align="center" data-bl="{{ $disc['bl'] }}"
                                                style="background: #f2f2f2;">
                                                <b>{{ $disc['bl'] }}</b>
                                            </td>
                                        </tr>
                    ...
                    @else
                        <h4 align="center" class="label-warning"><i class="fa fa-warning"></i>&nbsp;&nbsp;Belum
                            melaksanakan
                            test</h4>
                    @endif
                </div>
            ...
            <div class="list-item tab-pane" role='tab-panel' id='papi'>
                <button class='btn btn-success' id='btn' onclick='printpapi();'>print</button>
                <div id='papiprint'>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-1 text-center">
                                            <div class="papiscore row" data-L="{{ $papi['L']['score'] }}"
                                                data-label="Kemampuan mendelegasikan tugas">{{ $papi['L']['score'] }}
                                            </div>
                                            <div class="papiscore row" data-P="{{ $papi['P']['score'] }}"
                                                data-label="Kemampuan mengontrol & mengelola">{{ $papi['P']['score'] }}
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-1 text-center">
                                            ...
                                            <div class="papiscore row" data-O="{{ $papi['O']['score'] }}"
                                                data-label="Peka terhadap perasaan orang lain">{{ $papi['O']['score'] }}
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-1 text-center">
                                            ...
                                            <div class="papiscore row" data-C="{{ $papi['C']['score'] }}"
                                                data-label="Kemampuan merencanakan sesuatu">{{ $papi['C']['score'] }}
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
            ...
            <div class="list-item tab-pane" role='tab-panel' id='intel'>
                <button class='btn btn-success' id='btn' onclick='printintel();'>print</button>
                <div id='intelprint'>
                        ...
                        <div class="container-fluid pad-1em">
                            <div style="margin: auto; width:100%;">
                                <h3 align="center" class="text-success">Average Score :
                                    {{ interpretasi(array_sum($scores) / 5) }}
                                    {{ interpretasi2(array_sum($scores) / 5) }}
                                </h3>
                            </div>
                        </div>
                    @endif
    ...
    @push('scripts')
        ...
        <script type="text/javascript">
            function printmbti() {
                var divToPrint = document.getElementById('mbtiprint');
                var css = '';
                    ...
                    if (document.styleSheets[i].href) {
                        ...
                        try {
                            ...
                            for (var j = 0; j < rules.length; j++) {
                                css += '<style>' + (rules[j].cssText ? rules[j].cssText : rules[j].style.cssText) + '</style>';
                            }
                        } catch (e) {
                            console.log(e);
                        }
                ...
                newWin.document.write('<html><head>' + css + '</head><body onload="window.print()">' + divToPrint.innerHTML +
                    '</body></html>');
                newWin.document.close();
            }

            function printdisc() {
                var divToPrint = document.getElementById('discprint');
                var css = '';
                for (var i = 0; i < document.styleSheets.length; i++) {
                    if (document.styleSheets[i].href) {
                        css += '<link rel="stylesheet" type="text/css" href="' + document.styleSheets[i].href + '">';
            ...
            function printpapi() {
                var divToPrint = document.getElementById('papiprint');
                var css = '';
                for (var i = 0; i < document.styleSheets.length; i++) {
                    if (document.styleSheets[i].href) {
                        css += '<link rel="stylesheet" type="text/css" href="' + document.styleSheets[i].href + '">';
            ...
            function printintel() {
                var divToPrint = document.getElementById('intelprint');
                var css = '';
                for (var i = 0; i < document.styleSheets.length; i++) {
                    if (document.styleSheets[i].href) {
                        css += '<link rel="stylesheet" type="text/css" href="' + document.styleSheets[i].href + '">';

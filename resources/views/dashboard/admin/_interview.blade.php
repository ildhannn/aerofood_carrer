            ...
            <tbody>
                @foreach ($pass as $candidate)
                    ...
                    <tr>
                        ...
                        <td width="50%">
                            <div class="va-table">
                                <div class="va-middle result {{ is_int($interview[0]) ? $class[$interview[0]] : $class[$interview[0]->result] }}">
                                    <div class="btn" style="font-size: 10px !important;margin-right: 5px;">
                                        <div class='interviewer'><b>HC 1</b></div>
                                        <div class="detail">{!! is_int($interview[0]) ? $result[$interview[0]] : $result[$interview[0]->result] !!}</div>
                                    </div>
                                </div>

                                 <div
                                    class="va-middle result {{ is_int($interview[1]) ? $class[$interview[1]] : $class[$interview[1]->result] }}">
                                    <div class="btn" style="font-size: 10px !important;margin-right: 5px;">
                                        <div class='interviewer'><b>HC 2</b></div>
                                        <div class="detail">{!! is_int($interview[1]) ? $result[$interview[1]] : $result[$interview[1]->result] !!}</div>
                                    </div>
                                </div>

                                <div
                                    class="va-middle result {{ is_int($interview[2]) ? $class[$interview[2]] : $class[$interview[2]->result] }}">
                                    <div class="btn" style="font-size: 10px !important;margin-right: 5px;">
                                        <div class='interviewer'><b>User 1</b></div>
                                        <div class="detail">{!! is_int($interview[2]) ? $result[$interview[2]] : $result[$interview[2]->result] !!}</div>
                                    </div>
                                </div>

                                <div
                                    class="va-middle result {{ is_int($interview[3]) ? $class[$interview[3]] : $class[$interview[3]->result] }}">
                                    <div class="btn" style="font-size: 10px !important;margin-right: 5px;">
                                        <div class='interviewer'><b>User 2</b></div>
                                        <div class="detail">{!! is_int($interview[3]) ? $result[$interview[3]] : $result[$interview[3]->result] !!}</div>
                                    </div>
                                </div>

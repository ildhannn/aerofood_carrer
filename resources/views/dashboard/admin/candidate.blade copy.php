                    ...
                    <table id="tabel-kandidat" class="table table-striped table-bordered row-border order-column"
                        ...
                        <tbody>
                            @foreach ($candidates as $item)
                                <tr>
                                    <td>
                                        <img src="{{ asset($item->photo ? 'upload/candidates/' . md5($item->candidate_id . 'folder') . '/' . $item->photo : 'img/no-pic.jpg') }}" />
                                    </td>
                                    <td>
                                        <a class='view-profile' onclick="getCandidate({{ $item->candidate_id }} )" href='#' data-candidate='{{ $item->candidate_id }}'>{{ $item->user->name }}</a>
                                    </td>
                                    <td>
                                        {!! $item->city

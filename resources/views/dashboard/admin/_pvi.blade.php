			        ...
			        <tbody>
			        	@foreach($job->candidateProgressStatus('=', 1, 0) as $candidate)
				        	<tr>
			                    ...
			                    <td width="15%" align="center"><div><a href="{{route('pvi-candidate', [$job->job_id, $candidate->candidate_id])}}" data-toggle="tooltip" data-original-title="Lihat Hasil PVI"><i class="fa fa-external-link-square" style="font-size: 20px;"></i></a></div></td>
				...
				<table id="table-pvi-pass" class="table table-striped table-bordered row-border order-column" style="width:100%">
			        ...
			        <tbody>
			        	...
			        	<tr>
								...
								<td width="13%" align="center"><div><a href="{{route('pvi-candidate', [$job->job_id, $candidate->candidate_id])}}" data-toggle="tooltip" data-original-title="Lihat Hasil PVI"><i class="fa fa-external-link-square" style="font-size: 20px;"></i></a></div></td>

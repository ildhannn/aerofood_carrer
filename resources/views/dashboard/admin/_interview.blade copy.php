{{-- <div class="list-item tab-pane" role="tabpanel" id="interview">
	<div class="visible-xs-block"><h2><i class="fa fa-exchange"></i>&nbsp;INTERVIEW</h2></div>
	<ul class="nav nav-tabs sub-tab text-center" role='tab-list'>
		<?php  
			...
			?>
	  <li role="presentation" class="active"><a href="#interview-not-checked">Belum Diperiksa ({{$not_checked->count()}})</a></li>
	...
	<div class="tab-content">
		...
		<div class="list-item tab-pane active" role='tab-panel' id='interview-not-checked'>
			...
			<?php $class = ['danger', 'success', 'warning', 'default'] ?>
					...
					<div class="item">
						<table id="table-interview-not-checked" class="table table-striped table-bordered row-border order-column" style="width:100%">
				            <thead>
				                <tr>
				            ...
				            <tbody>
				            	...
				            	<tr>
				                    ...
				                    <td width="30%"><div><a class='view-profile' onclick="showProfile('{{$candidate->candidate_id}}')" href='#{{$candidate->candidate_id}}' data-candidate='{{$candidate->candidate_id}}'>{{$candidate->user->name}}</a></div></td>
				                    <td width="10%" align="center"><div><a href="{{route('interview-candidate', [$job->job_id, $candidate->candidate_id])}}" data-toggle="tooltip" data-original-title="Lihat Scoring Interview"><i class="fa fa-external-link-square" style="font-size: 20px;"></i></a></div></td>
				                    <td width="50%">
				                    	<div class="va-table">
											...
											<div class="va-middle result {{$class[$interview[4]]}}">
												<div class="btn" style="font-size: 10px !important;">
													<div class='interviewer'><b>User 3</b></div>
													<div class="detail">{!! $result[$interview[4]] !!}</div>
												</div>
											</div>
										</div>
				                    </td>
				                    	...
				                    	<div class="pull-right">
											...
											<div class="va-table width-100">
												<div class="va-middle width-100">
													<a href="#interview-modal" class='btn btn-primary invite interview width-100' data-candidate='{{$candidate->id}}' data-job-name='{{$job->title}}' data-job='{{$job->id}}' data-user='{{$candidate->user->name}}' data-interviewers='{{collect($interviewers)}}'>Undang interview</a>
													@else
		...
		<div class="list-item tab-pane" role='tab-panel' id='interview-pass'>
			<div class="item">
				<table id="table-interview-pass" class="table table-striped table-bordered row-border order-column" style="width:100%">
		            <thead>
		                <tr>
		                	<th width="3%" class="all"></th>
		                    <th width="30%" class="all">NAMA</th>
		            ...
		            <tbody>
						...
						<?php $interview = [
			            	...
			            	<tr>
			                    ...
			                    <td width="30%"><div><a class='view-profile' onclick="showProfile('{{$candidate->candidate_id}}')" href='#{{$candidate->candidate_id}}' data-candidate='{{$candidate->candidate_id}}'>{{$candidate->user->name}}</a></div></td>
			                    <td width="10%" align="center"><div><a href="{{route('interview-candidate', [$job->job_id, $candidate->candidate_id])}}" data-toggle="tooltip" data-original-title="Lihat Form Interview"><i class="fa fa-file-text" style="font-size: 20px;"></i></a></div></td>
			                    <td width="50%">
			                    	<div class="va-table">
										<div class="va-middle result {{$class[$interview[0]]}}">
											<div class="btn" style="font-size: 10px !important;margin-right: 5px;">
		...
		<div class="list-item tab-pane" role='tab-panel' id='interview-fail'>
			<div class="item">
				<table id="table-interview-fail" class="table table-striped table-bordered row-border order-column" style="width:100%">
		            <thead>
		                <tr>
		                	<th width="3%" class="all"></th>
		                    <th width="30%" class="all">NAMA</th>

<div class="list-item tab-pane active" role="tabpanel" id="candidate-list">
                ...
                <div>
                        ...
                        <div class="va-table">
                            <div class="va-middle">
                                <form method='POST' action='{{ route('fail') }}'>
                                    ...
                                    <button class='btn btn-danger' style="font-size: 10px;">Gagal&nbsp;<i
                            ...
                            <div class="va-middle">
                                <form method='POST' action='{{ route('pass') }}'>
                                    ...
                                    <input type="hidden" name="step_id" value="0">
                                    <button class='btn btn-success' style="font-size: 10px;">Lolos&nbsp;<i
                    ...
                    @else
                        @if ($candidate->pivot->status == 33 && $candidate->pivot->progress > 0)
                            <span class="label label-danger"><i>Gagal pada {{ $candidate->progress() }}</i></span>
    ...
    <div class="list-item tab-pane" role='tabpanel' id='not-matched'>
        ...
        <div class="item">
            <table id="table-not-matched" class="table table-striped table-bordered row-border order-column"
                style="width:100%">
                <thead>
                    <tr>
                        <th width="3%" class="all"></th>
                ...
                <tbody>
                    @foreach ($job->candidateProgressStatus('=', 0, 0) as $candidate)
                        <tr>
                            <td align="center">
                                <div class="picture"
                                    style="height: auto !important;overflow: auto !important;float: none;border-radius: 0px;">

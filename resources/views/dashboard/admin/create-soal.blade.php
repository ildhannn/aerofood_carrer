                        ...
                        <div class="row">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label class='col-sm-2 control-label ta-left'>JENIS SOAL</label>
                                    <div class="col-sm-10">
                                        <select id="jenis_soal" name="jenis_soal" required>
                                            <option value="">Pilih jenis soal</option>
                                            <option value="1">Pengetahuan Umum</option>
                                            <option value="2">Daya Tangkap Verbal</option>
                                            <option value="3">Berpikir Logis</option>
                                            <option value="4">Kemampuan Berhitung</option>
                                            <option value="5">Induktif</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">

...
@section('content')
    ...
    <div class="container-fluid" style="margin-left: 0px;margin-right: 0px;">
        <div class="row">
                ...
                <div class="form-group">
                    <div style="color: #fff;">
                        <div class="va-table" style="width: 100%;">
                            <div class="va-middle"
                                style="width: 5%;text-align: center;background-color: #3342EE; padding: 1em;"><i
                                    class="fa fa-graduation-cap fa-lg"></i></div>
                            <div class="va-middle" style="width: 65%;background-color: #3371EE; padding: 1em;">EDUCATION CANDIDATES</div>
                            <div class="va-middle"
                                style="width: 30%;text-align: center;background-color: #3371EE; padding: 1em;"><span
            ...
            <div class="col-md-1">
                <div class="form-group">
                    <div style="width: 100%; color: #fff;">
                        <div class="va-table" style="width: 100%;position: relative;">
                            <a data-toggle="collapse" href="#education" role="button" aria-expanded="false"
        ...
        <!-- modal education -->
        <div class="collapse" id="education" style="margin-bottom: 15px;">
              <div class="row">
                <div class="col-md-3">
                    <a class='view-profile' onclick='getCandidateEducation(0);' href='#'
                        style="text-decoration: none">
                        <div class="va-middle"
                            style="width: 100%;background-color: #5F9EA0; padding: 1em;color:white;">TINGKAT
                            SMA / SEDERAJAT</div>
                        <div class="va-middle"
                            style="text-align: center;background-color: #5F9EA0; padding: 1em;color:white">
                ...
                <div class="col-md-3">
                    <a class='view-profile' onclick='getCandidateEducation(1);' href='#'
                        style="text-decoration: none">
                        <div class="va-middle"
                            style="width: 100%;background-color: #008B8B; padding: 1em;color:white">
                            D1 - D2</div>
                        <div class="va-middle"
                            style="text-align: center;background-color: #008B8B; padding: 1em;color:white">
                ...
                <div class="col-md-2">
                    <a class='view-profile' onclick='getCandidateEducation(2);' href='#'
                        style="text-decoration: none">
                        <div class="va-middle"
                            style="width: 100%;background-color: #D2691E; padding: 1em;color:white">
                            D3</div>
                        <div class="va-middle"
                            style="text-align: center;background-color: #D2691E; padding: 1em;color:white">
                            <span style="font-size: 20px;">{{ $arr['arr_qualification'][2] }}</span>
                        </div>
                    </a>
                </div>
                <div class="col-md-2">
                    <a class='view-profile' onclick='getCandidateEducation(3);' href='#'
                        style="text-decoration: none">
                        <div class="va-middle"
                            style="width: 100%;background-color: #FF7F50; padding: 1em;color:white">
                            D4-S1</div>
                        <div class="va-middle"
                            style="text-align: center;background-color: #FF7F50; padding: 1em;color:white">
                            <span style="font-size: 20px;">{{ $arr['arr_qualification'][3] }}</span>
                        </div>
                    </a>
                </div>
                <div class="col-md-2">
                    <a class='view-profile' onclick='getCandidateEducation(4);' href='#'
                        style="text-decoration: none">
                        <div class="va-middle"
                            style="width: 100%;background-color: #6495ED; padding: 1em;color:white">
                            S2</div>
                        <div class="va-middle"
                            style="text-align: center;background-color: #6495ED; padding: 1em;color:white">
                            <span style="font-size: 20px;">{{ $arr['arr_qualification'][4] }}</span>
                        </div>
                    </a>
                </div>
            </div>

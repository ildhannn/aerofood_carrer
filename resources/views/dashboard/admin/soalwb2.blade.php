...
@section('breadcrumb')
    <b>Master Soal WB 2</b>
@stop

@section('content')
    <div class="header-sub">
        <div class="va-table width-100">
            <div class="va-middle width-50">SOAL WORK BEHAVIOR 2</div>
            <div class="va-middle width-50 ta-right">
                <a href="{{ route('dashboard-create-soalwb2') }}" class='btn blue width-100-m mar-b-1em-m'
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form method="POST" action="{{ route('delete-soalwb2') }}">
                                {{ csrf_field() }}
            ...
            <div class="list-item">
                <div class="item pad-0-m">
                    <table id="tabel-kandidat" class="table table-striped table-bordered row-border order-column"
                        ...
                        <tbody>
                            @foreach ($soalwb2 as $soal2)
                                <tr>
                                    <td style="text-align: center">
                                        {{ $soal2['id_soal'] }}
                                    </td>
                                    <td>
                                        {{ $soal2['pilihan1']->choice }}
                                    </td>
                                    <td style="text-align: center">
                                        {{ $soal2['pilihan1']->label }}
                                    </td>
                                    <td>
                                        {{ $soal2['pilihan2']->choice }}
                                    </td>
                                    <td style="text-align: center">
                                        {{ $soal2['pilihan2']->label }}
                                    </td>
                                    <td align="center">
                                        <a href="{{ route('dashboard-edit-soalwb2', $soal2['id_soal']) }}"
                                            data-toggle="tooltip" title="Ubah"><span class="btn btn-primary"><i
                                                    class="fa fa-pencil"></i></span></a>
                                        <a onclick="deleteSoal({{ $soal2['id_soal'] }},'{{ $soal2['id_soal'] }}')"

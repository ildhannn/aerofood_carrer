...
@section('breadcrumb')
    <a href="{{ route('dashboard-pvi') }}">Master PVI</a>&nbsp;&nbsp;&nbsp;<i
        ...
        <div class="col-md-12">
            <div class="header-sub">
                <div class="va-table width-100">
                    <div class="va-middle width-50">TAMBAH PVI</div>
            ...
            <div class="panel">
                <form method="POST" action="{{ route('create-pvi') }}">
                    {{ csrf_field() }}
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button class='btn blue pull-right'>Tambah PVI</button>
                                    </div>
                                </div>
                            </div>
                        </div>

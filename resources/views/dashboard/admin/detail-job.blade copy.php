        ...
        <div class="edit-job" style="margin-bottom: 0px;">
            @if ($job->status == 0)
                <div class="header-sub" style="width: auto !important;">
                    <div class="va-table width-100">
                      <div class="va-middle width-50 width-100-m">
                        JOB TITLE: <span style="text-transform: uppercase;"><b style="margin-right: 20px">{{ $job->title }}</b> </span>
                ...
                <div class="va-table width-100" style="border: 1px solid #ccc; padding: 10px 15px;background: #fff;">
                    ...
                    <div class="va-middle width-30 width-100-m display-in-block-m mar-b-2em-m ta-center-m">
                        <span type="button" class="label label-warning job-status" style="font-size: 17px;">DRAFT <i
                                class="fa fa-file"></i>
                        </span>
                    </div>
                ...
                <div class="va-table width-100" style="border: 1px solid #ccc; padding: 10px 15px;">
                    <div class="va-middle width-50 width-100-m display-in-block-m mar-b-1em-m ta-center-m">
                        <a href="{{ route('job-detail', $job->job_id) }}" class='btn btn-warning copy'
                            ...
                            style="background: #fff;width:auto;"><i class="fa fa-eye"></i> Pratinjau</a>
                    </div>
                    <div class="va-middle width-50 ta-right width-100-m display-in-block-m ta-center-m">
                        <a href="#close" class='btn btn-danger close-job' style="width:auto;"><i class="fa fa-close"></i>
                            Tutup
                            Lowongan</a>
                    </div>
                </div>
            ...
            @elseif($job->status == 1)
                <div class="header-sub" style="width: auto !important;">
                    <div class="va-table width-100">
                        ...
                        <div class="va-middle width-50 ta-right hidden-xs"><i class="fa fa-briefcase"></i></div>
                    </div>
                </div>
                <div class="va-table width-100" style="border: 1px solid #ccc; padding: 10px 15px;background: #fff;">

                    <div class="va-middle width-20 width-100-m display-in-block-m mar-b-1em-m ta-center-m">
                        STATUS LOWONGAN
                    </div>
                    <div class="va-middle width-30 width-100-m display-in-block-m mar-b-2em-m ta-center-m">
                        <span type="button" class="label label-success job-status" style="font-size: 17px;">PUBLISH <i
                    ...
                    <form action='{{ route('invite-interview') }}' method='POST' enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-9"><input type="date" name="date-interview" class="form-group">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="col-md-3">Waktu</label>
                                <div class="col-md-9"><input type="time" name="time-interview" class="form-group">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="col-md-3">Tempat</label>
                                <div class="col-md-9">
                                    <textarea name='place-interview' class="form-group"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="col-md-3">Interviewer</label>
                                <div class="col-md-9"><select name='interviewer' class="form-group"></select></div>
                            </div>
                        </div>
        ...
        $(function() {
            ...
            $(".invite.interview").on('click', function() {
                ...
                $('[name=interviewer]').append('<option value="' + interviewers[3] + '">' + interviewers[
                    3] + '</option>')
                $('[name=interviewer]').append('<option value="' + interviewers[4] + '">' + interviewers[
                    4] + '</option>')
